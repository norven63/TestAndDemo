...
public class TestDemo {
    public static void main(String[] args) {
        final SimpleDateFormat sdf = new SimpleDateFormat("yyyy年 MM月 dd日");
    ...
    static class A {
        ...
        public <V> List<V> testA(V v) {
            final List<V> returnVlaue = new ArrayList<V>();
            returnVlaue.add(v);
            return returnVlaue;
        }
    }
